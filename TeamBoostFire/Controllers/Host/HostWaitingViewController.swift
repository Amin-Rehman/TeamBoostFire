...
class HostWaitingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let meetingIdentifier = teamBoostKitDomainInstance().meetingIdentifier
    ...
    @IBAction func startMeetingClicked(_ sender: Any) {
        ...
        let teamBoostKitDomain = teamBoostKitDomainInstance()
        teamBoostKitDomain.startMeeting()
        let meetingParams = teamBoostKitDomain.meetingParams
